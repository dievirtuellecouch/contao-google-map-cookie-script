(function(){
  ...
  function loadGoogleMaps(apiKey) {
    ...
    loaderPromise = new Promise(function(resolve, reject){
      ...
      var src = base + '?v=weekly&libraries=maps,geocoding&loading=async&key=' + encodeURIComponent(apiKey);
      s.src = src;
      s.async = true;
      s.defer = true;
  ...
  function initAll() {
    ...
    var start = function(){ for (var i=0; i<nodes.length; i++) initOne(nodes[i]); };
    if (firstKey) {
